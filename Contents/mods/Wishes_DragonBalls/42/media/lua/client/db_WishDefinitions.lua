...
local function addGenieDefinitions()
    ...
    definitions:addWishDefinition("Shenron_modifyTrait"       , "UI_Shenron_modifyTrait"        , sandbox.WishCost_ModifyTrait, options.getTraits , blacklists.ModifyTrait)
    definitions:addWishDefinition("Shenron_skillLevelUpUntil" , "UI_Shenron_skillLevelUpUntil"  , sandbox.WishCost_SkillLevelUpUntil , options.getSkills, blacklists.SkillLevelUntil)
    definitions:addWishDefinition("Shenron_skillLevelUpOnce"  , "UI_Shenron_skillLevelUpOnce"   , sandbox.WishCost_SkillLevelUpOnce , options.getSkills, blacklists.SkillLevelOnce)
    ...
    definitions:addWishDefinition("Shenron_obtainItem"        , "UI_Shenron_obtainSpecialItem"  , sandbox.WishCost_ObtainSpecialItem , options.getDBItems , blacklists.ObtainItem)
